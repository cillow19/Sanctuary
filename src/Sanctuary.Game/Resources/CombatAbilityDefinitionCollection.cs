...
public sealed class CombatAbilityDefinitionCollection : ObservableConcurrentDictionary<int, AbilityDefinition>
{
    ...
    public CombatAbilityDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
